                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-4xl mx-auto">
                            <div className="prose prose-lg">
                                ...
                                <p className="text-gray-600 mb-6">
                                    A Padaria Tia Rosa valoriza a privacidade dos nossos clientes e visitantes. Esta Política de Privacidade descreve como coletamos, usamos, compartilhamos e protegemos suas informações pessoais quando você visita nosso site, faz pedidos online ou interage conosco de qualquer forma.
                                </p>
                                ...
                                <ul className="text-gray-600 space-y-2 list-disc pl-6 mb-6">
                                    <li>Informações pessoais: nome, endereço de e-mail, número de telefone e endereço de entrega que você nos fornece voluntariamente, como ao fazer pedidos online ou preencher formulários em nosso site.</li>
                                    <li>Informações de pagamento: detalhes do cartão de crédito ou outras informações financeiras necessárias para processar transações de pedidos.</li>
                                    <li>Informações de uso: dados sobre como você interage com nosso site, incluindo páginas visitadas, tempo gasto no site e preferências de produtos.</li>
                                ...
                                <ul className="text-gray-600 space-y-2 list-disc pl-6 mb-6">
                                    <li>Fornecer, manter e melhorar nossos produtos de padaria e serviços de entrega.</li>
                                    <li>Processar pedidos online e enviar comunicações relacionadas aos seus pedidos.</li>
                                    <li>Responder a suas perguntas, comentários ou solicitações sobre nossos produtos.</li>
                                    <li>Personalizar sua experiência e fornecer ofertas de produtos que possam ser de seu interesse.</li>
                                    <li>Monitorar e analisar tendências de pedidos, uso e atividades em nosso site.</li>
                                ...
                                <ul className="text-gray-600 space-y-2 list-disc pl-6 mb-6">
                                    <li>Fornecedores de serviços que nos auxiliam em nossas operações comerciais, como processamento de pagamentos, serviços de entrega, análise de dados, marketing por e-mail e suporte ao cliente.</li>
                                ...
                                <p className="text-gray-600 mb-6">
                                    Se você tiver dúvidas sobre esta Política de Privacidade ou sobre o tratamento dos seus dados, entre em contato conosco pelo e-mail: privacidade@tiarosa.com ou pelo telefone (11) 1234-5678.
                                </p>
                            </div>
                        </div>
                    </div>
